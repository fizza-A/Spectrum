...
$sql = sprintf("SELECT * FROM bands_info WHERE Licensee LIKE '%%%s%%' OR (Radio_Service='%s' AND freqInputLower='%f' AND freqInputUpper='%f')",
...
<form name="query" method="POST" action="bands.php">
